...
| 35 | Schlachtsystem | ✅ | Eigenständige Kampf-Engine vollständig integriert: 6 Kampfphasen, 5 Formationen + 7 Taktiken, Schere-Stein-Papier-Konter, 6 Geländearten, 5 Wettertypen, Moralsystem mit Fluchtmechanik, Kommandanten-Ereignisse, Entscheidungspunkte während der Schlacht, deterministischer Seed, Debug-Modus, 6 automatisierte Tests — kein reiner Stärkevergleich mehr. Seit Schritt 38 zusätzlich als strategische Ebene eine Risiko-artige Kriegskarte (16 Gebiete über die 4 kriegsfähigen Regionen, Truppenstationierung/-verlegung, Gebiet-für-Gebiet-Eroberung) — jeder Gebietskampf läuft weiterhin über dieselbe Kampf-Engine |
| 36 | Belagerungen | 🟡 | Die alte, regionsweite Belagerungsmechanik (mehrjähriges Aushungern/Bestechen vor einem Sturmangriff) wurde mit der Kriegskarte (Schritt 38) bewusst zurückgestellt — eine befestigte Hauptstadt bekommt stattdessen automatisch den "Burg"-Geländebonus der Kampf-Engine, wenn sie als Gebiet angegriffen wird. Der alte Code (startSiege/siegeStarve/siegeBribe) bleibt unbenutzt im Projekt erhalten, falls eine echte gebietsspezifische Belagerung später ergänzt werden soll |
